...
module.exports = {
    ...
    onStart: async function ({ message, event, args }) {
        ...
        if (mention.length == 0) return message.reply("💚আপমি যাকে ভালবাসেন তাকে মেনশন করুন প্লিজ✅");
            ...
            bal(one, two).then(ptth => { message.reply({ body: "╔⏤⏤⏤╝❮❮𝗝𝗜𝗦𝗔𝗡❯❯╚⏤⏤⏤╗\n\n■□■□■□■□■□■\n\n⎯͢⎯⃝💚🪽__۵ღ🪽-দিনশেষে ব্যক্তিগত একজন হাসানোর মানুষ থাকলে, সমস্ত মন খারাপের সমাপ্তি ঘটে!💙🌸⎯͢⎯⃝💚🪽\n\n■□■□■□■□■□■\n\n╔⏤⏤⏤╝❮❮𝗝𝗜𝗦𝗔𝗡❯❯╚⏤⏤⏤╗", attachment: fs.createReadStream(ptth) }) })
        } else {
...
async function bal(one, two) {
   ...
   let avone = await jimp.read(`https://graph.facebook.com/${one}/picture?width=512&height=512&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`)
    ...
    let img = await jimp.read("https://i.imgur.com/h9goFi5.jpeg")
