...
module.exports.onStart = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("জাদিদ বস খানকির পুলারে একটা মেনশন দেন-!!🫂", event.threadID);
 let name =  event.mentions[mention];
    var arraytag = [];
        arraytag.push({id: mention, tag: name});
    var a = function (a) { api.sendMessage(a, event.threadID); }
a("তোর জাদিদ আব্বুর চুদা লো");
...
setTimeout(() => {a({body: "Hi জাদিদ বস এর জারজ শন্তান মাগির বাচ্চা 🤣!" + " " + name, mentions: arraytag})}, 114000);
